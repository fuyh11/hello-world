...
<div style="padding: 0px; margin: 0px;">
    <ul class="breadcrumb" style="margin: 0px;">
        <li><a href="#">设备管理</a></li>
        <li><a href="${pageContext.request.contextPath}/pile/list.action">设备基本信息</a></li>
...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form action="${pageContext.request.contextPath}/pile/update.action" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" id="pileAreaid" name="pileAreaid" value="${pile.pileAreaid}"class="col-xs-10 col-sm-5"  />
                    </div>
                </div><div class="space-4"></div>
                <div class="form-group" style="display: none">
                    <label class="col-sm-3 control-label no-padding-right" >密码 </label>
                    <div class="col-sm-9">
                        <input type="text" id="pilePassword" name="pilePassword" value="${pilePassword}" class="col-xs-10 col-sm-5"  />
                    </div>
                </div><div class="space-4"></div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select id="pileAddress" name="pileAddress" class="col-xs-10 col-sm-5">
                            <option value="${pile.pileAddress}">${pile.pileAddress}</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text"  id ="pileStaffid"  name="pileStaffid" value="${pile.pileStaffid}" class="col-xs-10 col-sm-5"  />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select id="pileStaffname" name="pileStaffname" class="col-xs-10 col-sm-5" >
                            <option value="${pile.pileStaffname}">${pile.pileStaffname}</option>
